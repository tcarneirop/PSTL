...
export PSTL_HOME=/home/carneiro/parallelStl
export LLVM_ROOT=/usr/lib/llvm-18
export CC=$LLVM_ROOT/bin/clang
export CXX=$LLVM_ROOT/bin/clang++
export LD_LIBRARY_PATH=$LLVM_ROOT/lib:/opt/rocm-6.2.4/lib:$LD_LIBRARY_PATH
...
echo "To test: $ACPP_INSTALL_DIR/bin/acpp --acpp-stdpar --acpp-targets='hip:gfx1032' test.cpp"
echo "------------------------------------------------"
