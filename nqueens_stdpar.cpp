...
inline bool GPU_queens_stillLegal(const char * RESTRICT board, const int r) {
    ...
    for (int i = 0, rev_i = r - 1, offset = 1; i < r; ++i, --rev_i, offset++) {
        // Bitwise operations minimize branching for the GPU
...
int main(int argc, char *argv[]) {
    ...
    // Sufficient buffer for subproblems
    ...
    // 2. Prepare Parallel Infrastructure
    ...
    // 3. Extract Restricted Pointers for GPU Lambda Capture
    ...
    // 4. Parallel Execution (Offloads to GPU via AdaptiveCpp)
